...
class ListSurveyBPK extends StatefulWidget {
  ...
  @override
  State<ListSurveyBPK> createState() => _ListSurveyBPKState();
}

class _ListSurveyBPKState extends State<ListSurveyBPK> {
  bool loading = true;
  String? errorMessage;
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Expanded(
                  child: Text(
                    "Survei Pengukuran Capaian SPM Penyelenggaraan Badan Pemeriksa Keuangan Tahun 2026",
                    style: TextStyle(
                      fontSize: 13,
            ...
            Row(
              children: [
                ...
                if (survey.provinceTargets.isEmpty)
                  ...
                  const Spacer(),
                _StatusBadge(isOpen: survey.isOpen),
              ],
            ),

            // ── Target Provinces Section ─────────────
